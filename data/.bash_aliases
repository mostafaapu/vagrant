...
alias x='exit'
alias c='clear'
alias src='cd && sudo cp vagrant_data/.bash_aliases . && source ~/.bashrc'
...
alias k='sudo pkill'
alias amq='sudo /opt/apache-activemq-5.16.0/bin/activemq start'
alias amq_stop='sudo /opt/apache-activemq-5.16.0/bin/activemq stop'
alias ps='ps -la'
